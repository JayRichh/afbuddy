<template>
  <div class="info-container">
    <p>This application allows users to spoof their geolocation, customize their
      browsing experience, and more. Use each section on the left navbar to
      access different functionalities.</p>
  </div>
  ...
  <div>
    <input type="checkbox" id="remember-language" v-model="rememberLanguage" @change="saveLanguage">

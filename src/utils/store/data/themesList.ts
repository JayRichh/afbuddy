...
export const themesArray: Record<string, Theme> = {
  active4d: {
    base: 'vs',
    inherit: true,
    rules: [
...
// export const themesArray: {Promise<Theme>[] = themeNames.map(async (name) => {
//   const themeURL = chrome.runtime.getURL(
//     `../popup/components/themes/${name}.json`
//   );
...
// /**
//  * Get the array of themes
//  * @returns {Promise<Theme[]>} Array of theme objects.
//  */
// export const getThemeList = async (): Promise<Theme[]> => {
//   return themesArray;
// };
...
// /**
//  * Filter themes by light or dark.
//  * @param {string[]} themes - Array of theme names.
//  * @param {boolean} light - True for light themes, false for dark themes.
//  * @returns {string[]} - Array of theme names.
//  */
// export const filterThemes = (themes: string[], light: boolean): string[] => {
//   return themes.filter(
//     (theme) => isLight(getTheme(theme).colors["editor.background"]) === light
//   );
// };
